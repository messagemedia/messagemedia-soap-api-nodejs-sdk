...
app.post('/api/sendMessage', function(req, res){
  messagemedia.sendMessage(req.body.userId, req.body.password, req.body.content, req.body.numbers, req.body.deliveryReport, req.body.scheduledTime,
      req.body.messageId, function(result){
        res.send(result);
      }
  );
});
