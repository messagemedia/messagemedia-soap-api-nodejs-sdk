module.exports = function(userId, password, content, recipients, deliveryReport, scheduledTime, messageId, callback) {
  ...
  recipients.forEach(function(recipient, index) {
    ...
    if (messageId) {
      _recipient.attrib.uid = messageId;
    } else {
  ...
  var _deliveryReport = subElement(_message, 'ns:deliveryReport');
  _deliveryReport.text = deliveryReport;

  if (scheduledTime) {
    var _scheduled = subElement(_message, 'ns:scheduled');
    _scheduled.text = scheduledTime;
  }
